...
class Settings(BaseSettings):
    ...
    ONLY_MODELS: str = ""
    EXCLUDED_KEYWORDS: str = "icloud,blokada,na części,na czesci,uszkodzony,uszkodzona,do naprawy"
    ...
    OLX_SEARCH_URL: str = "https://www.olx.pl/oferty/q-iphone/?search%5Border%5D=created_at%3Adesc"
    ...
    BASELINE_MAX_OFFERS_PER_QUERY: int = 45
    BASELINE_MIN_SAMPLES_FOR_STORAGE: int = 5
    BASELINE_MIN_SAMPLES_FOR_MODEL: int = 8

    FILTER_STRICT_MODE: bool = True
    STRICT_REQUIRE_IPHONE_IN_TITLE: bool = True
