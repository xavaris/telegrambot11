        ...
        try:
            ...
            for i in range(count):
                try:
                    ...
                    offer = Offer(
                        source=self.source_name, title=title, url=url, price=price,
                        location=location_text, image_url=img, description="",
                        condition=condition, model=model, storage=storage, color=color,
